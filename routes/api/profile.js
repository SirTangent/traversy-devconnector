...
router.get('/github/:username', (req, res) => {
    try {
        const options = {
            uri: `https://api.github.com/users/${req.params.username}/repos?per-page=5&sort=created:asc&client_id=${process.env.GITHUB_CLIENT_ID || config.get('githubClientId')}&client_secret=${process.env.GITHUB_SECRET || config.get('githubSecret')}`,
            method: 'GET',
